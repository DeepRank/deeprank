...
'''
classID : contains a classification of the conformations we want for the training set
		  <class> <complex_name>
...
decoys  : path to the decoy files generated by HADDOCK
          the script will look for all the pdb files contained 
          in any subdirectory of this folder.

natives : path to the native confomrmation
          the script will consider all the pdb files contained here

features : dictionnary containing the name and path to the features
			{'PSSM' : path/to/PSSM/files}

targets  : dictionnary containing the desires targets example
