...
class DeepRankConvNet():
	...
	Arguments
		...
		data_set : Data set generated by the DeepRankDataSet

				   data_set = DeepRankDataSet( ... )

		model    : definition of the NN to use. Must subclass nn.Module.
		...
		outdir      : output directory where all the files will be written
...
if __name__ == "__main__":
	...
	model.optimizer = optim.SGD(model.net.parameters(),lr=0.001,momentum=0.9,weight_decay=0.005)

	# start the training
	model.train(nepoch = 250)
	#net.train_kfold(k=5,nepoch=5)
	#net.train_montecarlo(nmc=2,nepoch=5)
